...
is1 ="""
?[fn, ln, br,ip,brw,city_name] := n=143, *node_label[n, "person"], *node_prop[n, "firstName", fn], *node_prop[n, "lastName", ln], *node_prop[n, "locationIP", ip], *node_prop[n, "birthday", br], *node_prop[n, "browserUsed", brw],  *edge_label[e, "isLocatedIn"], *edge[e,n,n2],*node_label[n2, l], l = "place", *node_prop[n2, "name", city_name]
"""
...
# print(client.run(ic1))
ic13="""
# for sf03 933 32985348834483 
# for sf03 933 32985348834886 
# for sf1 3528, 1345657873732
...
"""
# print(client.run(ic14org))

ic14= """ 
#for sf01 933 32985348834483
# for sf03 933 32985348834886 
# for sf1 3528, 1345657873732
# Définir le graphe orienté des relations KNOWS
knowsEdges[from, to] :=
...
# Nombre de réponses d'une personne A à un post|| comment de B
postCommentCount[a, b, count(p), count(c2)] :=
    *node_label[c, "comment"],
    *edge[e1, c, a],
    *edge_label[e1, "hasCreator"],
    *edge[e2, c, p],
    ...
    *node_label[c2, "comment"],
    *edge[e5, c2, b],
    *edge_label[e5, "hasCreator"]

# Calcul du poids entre deux personnes A et B
pairWeight[a, b, weight] :=
    postCommentCount[a, b, p1, c1],
    postCommentCount[b,  a, p2, c2],
    weight = p1 + c1 * 0.5 + p2 + c2 * 0.5
